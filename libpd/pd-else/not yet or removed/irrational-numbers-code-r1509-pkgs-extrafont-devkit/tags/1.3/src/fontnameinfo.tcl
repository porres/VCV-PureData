...
if 0 {
# to do ...  score deve prendere in considerazione la current platform
# e aggiustare i pesi in conformita'
# la current platform pero' deve essere un parametro 'esterno' in modo da potere calcolare
